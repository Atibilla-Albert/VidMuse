...
import api, { CreateProjectResponse } from '../services/api';
...
export default function CreateScreen({ navigation }: Props) {
  const [storyText, setStoryText] = useState(
    'In a futuristic city, a young inventor discovers a mysterious device that can manipulate time.'
  );
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const res = await api.post<CreateProjectResponse>('/projects/create', {
        prompt: storyText,
        style: videoStyle,
      ...
      const projectId = res?.data?.projectId || `demo-project-${Date.now()}`;
      ...
      // Even on error, navigate with demo data
        ...
        <View style={styles.card}>
          ...
          <View style={styles.tip}>
            ...
            <Text style={styles.tipText}>
              Add emotions, camera angles, or environment details.
            </Text>
          </View>
